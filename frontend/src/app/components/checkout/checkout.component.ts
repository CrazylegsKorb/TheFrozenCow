...
export class CheckoutComponent implements OnInit {
  ...
  //collapsing billingAddress component flag
  ...
  */
  ...
  setupStripPaymentForm() {
    ...
    this.cardElement.on('change', (event:any) => {
      ...
      // get a handle on card-errors element
    ...
    this.checkoutService.placeOrder(purchase).subscribe({
        next: response => {
          ...
          console.log( `-----\n`
                      ...
                      +`  Email: ${purchase.customer.email}\n`
                      +`  Shipping address: ${JSON.stringify(purchase.shippingAddress)}\n`
                      +`  Billing address: ${JSON.stringify(purchase.billingAddress)}\n`
                      +`  Order items ${JSON.stringify(purchase.orderItems, null, " ")}\n`
                      +`-----`);
  ...
  copyShippingAddressToBillingAddress(event: any) {
    if (event.target.checked) {
      ...
      //to hide billingAddress div after copy
      ...
      //to reveal billingAddress div after clear
